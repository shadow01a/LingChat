...
from ling_chat.core.ai_service.proactive_system.activity_monitor import (
    UserActivityMonitor,
    VisualMonitor,
)
...
from ling_chat.core.ai_service.proactive_system.strategy_dispatcher import (
    StrategyDispatcher,
)
...
class ProactiveSystem:
    def __init__(
        ...
        self.schedule_manager = ScheduleManager(
            self.settings, game_status, self.interest_manager
        )
